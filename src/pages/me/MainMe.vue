    ...
    <div class="me_background">
      <div class="me_pannel">
        <div class="flex_box flex_start">
          <div class="sculpture"><img :src="user.sculp"></div>
    ...
    <div class="cell_pannel">
      <div class="top flex_betwen line_bottom">
        ...
        <div class="flex_end">
          ...
          <div class="grey_arrow"><img src="/static/img/common_rightarrow_grey.png"></div>
        </div>
      </div>
      <ul class="order_box flex_betwen">

        <template v-for="(order,index) in orders" >
          <router-link class="btn" :key="index+'router'" tag="li" :to="order.link">
      ...
      <router-link tag="div" :to="opt.link" class="lists_box" v-for="(opt,index) in options" :key="index">
        <div class="list flex_betwen">
          ...
          <div class="right flex_betwen" :class="{'line_bottom':index!==(options.length-1)}">
            ...
            <div class="arrow"><img src="/static/img/common_rightarrow_black.png"></div>
          </div>
        </div>
...
export default {
  ...
  data () {
    return {
      ...
      options:[
        {title:'收货地址管理',icon:'/static/img/me_icons_5.jpg',link:'/address'},
        {title:'关注公众号',icon:'/static/img/me_icons_4.jpg',link:'/theOther/QRcode'},
        {title:'密码修改',icon:'/static/img/me_icons_3.jpg',link:'/sign/alter1'},
        {title:'用户反馈',icon:'/static/img/me_icons_2.jpg',link:'/theOther/feedback'},
        {title:'帮助',icon:'/static/img/me_icons_1.jpg',link:'/theOther/help'},
      ]
    }
  }
...
.me_background{
	width: 100%;
	height: 120px;
	background-image: url('/static/img/me_backgroundimg.jpg');
...
.order_box .order_icon{
	...
	height: 10vw;
	position: relative;
	background-image: url('/static/img/me_order_icon.jpg');
	background-repeat: no-repeat;
